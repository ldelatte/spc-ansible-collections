...
#ExcludePath ^/proc/
#ExcludePath ^/sys/
ExcludePath ^{{ ansible_user_dir }}/.local/share/containers/storage/
ExcludePath ^{{ ansible_user_dir }}/.ssh/
ExcludePath ^{{ ansible_user_dir }}/.ansible/tmp/
ExcludePath ^{{ ansible_user_dir }}/.config/
...
OnAccessIncludePath /home/*/Téléchargements
